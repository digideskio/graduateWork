...
\node at (10.85, 1.75) {Unused or};
\node at (10.85, 1.25) {for cell counts};
\end{tikzpicture}
\end{center}
...
\section{Procedure for Infecting Cells Following Lentiviral Transfection}
...
Freeze transfected cells two or more times, thawing fully between each freeze.