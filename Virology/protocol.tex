...
\section{Procedure for activating RV SA11 and Infecting MA104 Cells}
...
Incubate these plates for 2 hours at $37^{\circ}$C. After 2 hours, add to each of the experimental wells $2$mL complete M199. Using a second pipet, add to each of the control wells $2$mL complete M199. The final volume of medium in each well should be $3$mL. Incubate for 48 hours at $37^{\circ}$C.

\section{Procedure for Infecting Cells Following Lentiviral Transduction}
...
Count the cells in a sample well using the procedure described in ``Procedure for Plating MA104 Cells.'' Using this information, calculate the required volume of SA11 stock (maintained at a concentration of $5\e{7}$PFU/mL) per well, given the MOI desired.
...
Prepare a solution of $3$mL serum-free M199 and $0.75\mu$L $2$mg/mL trypsin for each well. Aspirate the viral inoculant from each well and replace with $3$mL of the serum-free M199 solution. Spread evenly by shaking and incubate plates at $37^{\circ}$C overnight.

\section{Procedure for Lysing Transfected Cells Following RV Infection}
